...
func (z *Block) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 8
	// write "height"
	err = en.Append(0x88, 0xa6, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74)
	if err != nil {
		return
	}
...
func (z *Block) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 8
	// string "height"
	o = append(o, 0x88, 0xa6, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74)
...
func (z *Block) Msgsize() (s int) {
	s = 1 + 7 + msgp.IntSize + 10 + msgp.Uint32Size + 10 + msgp.StringPrefixSize + len(z.Generator) + 12 + msgp.BytesPrefixSize + len(z.MerkleRoot) + 10 + msgp.Float64Size + 9 + msgp.BytesPrefixSize + len(z.PreviousHash) + 13 + msgp.ArrayHeaderSize
	for za0001 := range z.Transactions {
